 ...
 * John Bradley. Eric Kischell (keesh@ieee.org) converted these functions to
 * Java and inteegrated them into the PolygonRoi class.
 */
public class SplineFitter
{
	...
	/**
	 * Given arrays of data points x[0..n-1] and y[0..n-1], computes the values
	 * of the second derivative at each of the data points y2[0..n-1] for use in
	 * the splint function.
	 */
